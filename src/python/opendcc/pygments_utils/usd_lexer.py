...
class UsdLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"\b(inherits|references|variants|payload|subLayers)\b", Keyword.Type),
            (
            ...
            (r"[=,]", Operator),
            (
                r"\b(kind|defaultPrim|upAxis|startTimeCode|endTimeCode|framesPerSecond|metersPerUnit|instanceable|hidden|active)\b",
                Operator.Word,
            ),
            (r"\b(uniform|custom)\b", Operator.Word),
