    ...
    : QWidget(parent)
{
    ...
    QObject::connect(_treeView, &HduiSceneIndexObserverLoggingTreeView::RecordingStarted,
                     [this]() { this->_startStopButton->setText("Stop Recording"); });

    QObject::connect(_treeView, &HduiSceneIndexObserverLoggingTreeView::RecordingStopped,
                     [this]() { this->_startStopButton->setText("Start Recording"); });
}
