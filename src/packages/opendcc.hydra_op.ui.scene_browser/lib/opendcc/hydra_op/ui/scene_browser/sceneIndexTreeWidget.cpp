...
{
public:
    Hdui_SceneIndexPrimTreeWidgetItem(QTreeWidgetItem *parentItem, const SdfPath &primPath, bool queryOnExpansion = false)
    ...
    void WasExpanded(HduiSceneIndexTreeWidget *treeWidget)
    {
        ...
        if (count)
        {
            ...
            {
                if (Hdui_SceneIndexPrimTreeWidgetItem *childItem = dynamic_cast<Hdui_SceneIndexPrimTreeWidgetItem *>(child(0)))
                {
        ...
        for (const SdfPath &childPath : treeWidget->_inputSceneIndex->GetChildPrimPaths(_primPath))
        {
            ...
            Hdui_SceneIndexPrimTreeWidgetItem *childItem = new Hdui_SceneIndexPrimTreeWidgetItem(this, childPath, true);
    ...
    : QTreeWidget(parent)
{
    ...
    connect(this, &QTreeWidget::itemSelectionChanged, [this]() {
        ...
        if (Hdui_SceneIndexPrimTreeWidgetItem *primItem = dynamic_cast<Hdui_SceneIndexPrimTreeWidgetItem *>(items[0]))
        {
    ...
    connect(this, &QTreeWidget::itemExpanded, [this](QTreeWidgetItem *item) {
        if (Hdui_SceneIndexPrimTreeWidgetItem *siItem = dynamic_cast<Hdui_SceneIndexPrimTreeWidgetItem *>(item))
        {
...
void HduiSceneIndexTreeWidget::PrimsAdded(const HdSceneIndexBase &sender, const AddedPrimEntries &entries)
{
...
void HduiSceneIndexTreeWidget::PrimsRemoved(const HdSceneIndexBase &sender, const RemovedPrimEntries &entries)
{
...
void HduiSceneIndexTreeWidget::PrimsDirtied(const HdSceneIndexBase &sender, const DirtiedPrimEntries &entries)
{
    ...
    if (Hdui_SceneIndexPrimTreeWidgetItem *item = dynamic_cast<Hdui_SceneIndexPrimTreeWidgetItem *>(items[0]))
    {
...
void HduiSceneIndexTreeWidget::PrimsRenamed(const HdSceneIndexBase &sender, const RenamedPrimEntries &entries)
{
...
void HduiSceneIndexTreeWidget::Requery(bool lazy)
{
    ...
    _primItems[SdfPath::AbsoluteRootPath()] = new Hdui_SceneIndexPrimTreeWidgetItem(invisibleRootItem(), SdfPath::AbsoluteRootPath(), true);
}

Hdui_SceneIndexPrimTreeWidgetItem *HduiSceneIndexTreeWidget::_GetPrimItem(const SdfPath &primPath, bool createIfNecessary)
{
    ...
    Hdui_SceneIndexPrimTreeWidgetItem *item = new Hdui_SceneIndexPrimTreeWidgetItem(parentItem, primPath);
...
void HduiSceneIndexTreeWidget::_AddPrimItem(const SdfPath &primPath, Hdui_SceneIndexPrimTreeWidgetItem *item)
{
    _primItems[primPath] = item;
}
...
void HduiSceneIndexTreeWidget::contextMenuEvent(QContextMenuEvent *event)
{
    ...
    if (item)
    {
        ...
        if (Hdui_SceneIndexPrimTreeWidgetItem *typedItem = dynamic_cast<Hdui_SceneIndexPrimTreeWidgetItem *>(item))
        {
            QMenu menu;
