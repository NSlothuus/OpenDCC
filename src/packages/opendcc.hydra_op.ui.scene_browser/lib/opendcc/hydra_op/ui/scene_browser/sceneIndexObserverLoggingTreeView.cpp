...
void HduiSceneIndexObserverLoggingTreeView::_ObserverModel::PrimsAdded(const HdSceneIndexBase &sender, const AddedPrimEntries &entries)
{
    if (!_isRecording)
    {
        return;
...
void HduiSceneIndexObserverLoggingTreeView::_ObserverModel::PrimsRemoved(const HdSceneIndexBase &sender, const RemovedPrimEntries &entries)
{
    if (!_isRecording)
    {
        return;
...
void HduiSceneIndexObserverLoggingTreeView::_ObserverModel::PrimsDirtied(const HdSceneIndexBase &sender, const DirtiedPrimEntries &entries)
{
    if (!_isRecording)
    {
        return;
...
#if PXR_VERSION >= 2408
void HduiSceneIndexObserverLoggingTreeView::_ObserverModel::PrimsRenamed(const HdSceneIndexBase &sender, const RenamedPrimEntries &entries)
{
    if (!_isRecording)
    {
        return;
...
HduiSceneIndexObserverLoggingTreeView::_ObserverModel::_NoticeModelBase *HduiSceneIndexObserverLoggingTreeView::_ObserverModel::_GetModelBase(
    void *ptr) const
{
    if (!ptr)
    {
...
QVariant HduiSceneIndexObserverLoggingTreeView::_ObserverModel::data(const QModelIndex &index, int role) const
{
...
QVariant HduiSceneIndexObserverLoggingTreeView::_ObserverModel::headerData(int section, Qt::Orientation orientation, int role) const
{
    if (role == Qt::DisplayRole)
    {
        if (section == 0)
...
QModelIndex HduiSceneIndexObserverLoggingTreeView::_ObserverModel::index(int row, int column, const QModelIndex &parent) const
{
    if (parent.isValid())
    {
...
QModelIndex HduiSceneIndexObserverLoggingTreeView::_ObserverModel::parent(const QModelIndex &index) const
{
...
int HduiSceneIndexObserverLoggingTreeView::_ObserverModel::columnCount(const QModelIndex &parent) const
{
    return 2;
}

int HduiSceneIndexObserverLoggingTreeView::_ObserverModel::rowCount(const QModelIndex &parent) const
{
    if (parent.column() > 0)
    {
        return 0;
...
const char *HduiSceneIndexObserverLoggingTreeView::_ObserverModel::_AddedPrimsNoticeModel ::noticeTypeString()
{
...
QVariant HduiSceneIndexObserverLoggingTreeView::_ObserverModel::_AddedPrimsNoticeModel ::data(const QModelIndex &index, int role)
{
...
const char *HduiSceneIndexObserverLoggingTreeView::_ObserverModel::_DirtiedPrimsNoticeModel ::noticeTypeString()
{
...
QVariant HduiSceneIndexObserverLoggingTreeView::_ObserverModel::_DirtiedPrimsNoticeModel ::data(const QModelIndex &index, int role)
{
    if (index.row() >= static_cast<int>(_entries.size()))
    {
        return QVariant();
...
const char *HduiSceneIndexObserverLoggingTreeView::_ObserverModel::_RemovedPrimsNoticeModel ::noticeTypeString()
{
...
QVariant HduiSceneIndexObserverLoggingTreeView::_ObserverModel::_RemovedPrimsNoticeModel ::data(const QModelIndex &index, int role)
{
    if (index.row() >= static_cast<int>(_entries.size()))
    {
        return QVariant();
...
const char *HduiSceneIndexObserverLoggingTreeView::_ObserverModel::_RenamedPrimsNoticeModel ::noticeTypeString()
{
...
QVariant HduiSceneIndexObserverLoggingTreeView::_ObserverModel::_RenamedPrimsNoticeModel ::data(const QModelIndex &index, int role)
{
    if (index.row() >= static_cast<int>(_entries.size()))
    {
        return QVariant();
