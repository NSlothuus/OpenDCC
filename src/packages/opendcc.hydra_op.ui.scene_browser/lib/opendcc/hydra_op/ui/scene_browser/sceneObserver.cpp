...
void HduiSceneObserver::Subscribe(const HdSceneIndexBasePtr& sceneIndex)
{
    if (!sceneIndex)
    {
...
void HduiSceneObserver::Unsubscribe()
{
    if (_index)
    {
...
void HduiSceneObserver::SetBatchingEnabled(bool enabled)
{
...
void HduiSceneObserver::FlushBatchedUpdates()
{
...
void HduiSceneObserver::PrimsAdded(const HdSceneIndexBase&, const AddedPrimEntries& entries)
{
    TRACE_FUNCTION();
...
void HduiSceneObserver::PrimsRemoved(const HdSceneIndexBase&, const RemovedPrimEntries& entries)
{
    TRACE_FUNCTION();
...
void HduiSceneObserver::PrimsDirtied(const HdSceneIndexBase&, const DirtiedPrimEntries& entries)
{
    if (_batching)
    {
...
void HduiSceneObserver::PrimsRenamed(const HdSceneIndexBase&, const RenamedPrimEntries& entries)
{
    TRACE_FUNCTION();
...
void HduiSceneObserver::_BatchAddedPrim(const SdfPath& primPath)
{
    _batchedAddedPrims.insert(primPath);
}

void HduiSceneObserver::_BatchRemovedPrim(const SdfPath& primPath)
{
    _batchedRemovedPrims.insert(primPath);
}

void HduiSceneObserver::_BatchDirtiedPrim(const SdfPath& primPath, const HdDataSourceLocatorSet& dirtyLocators)
{
    _batchedDirtiedPrims[primPath].insert(dirtyLocators);
}

void HduiSceneObserver::_ClearBatchedChanges()
{
    _batchedAddedPrims.clear();
    _batchedRemovedPrims.clear();
    _batchedDirtiedPrims.clear();
