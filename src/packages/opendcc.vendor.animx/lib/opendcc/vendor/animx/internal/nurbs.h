...
namespace adsk
{
    namespace nurbs
    {
        ...
        double zeroin2(double a, double b, double fa, double fb, double tol, Polynomial* pars)
        {
            int test;
        ...
        int polyZeroes(double Poly[], int deg, double a, int a_closed, double b, int b_closed, double Roots[])
        {
