...
namespace adsk
{
    ...
    {
    private:
        static void bezierToPower(double a1, double b1, double c1, double d1, double &a2, double &b2, double &c2, double &d2)
        {
            double a = b1 - a1;
            double b = c1 - b1;
            double c = d1 - c1;
    ...
    public:
        static double evaluate(double startX, double startY, double x1, double y1, double x2, double y2, double endX, double endY, double time)
        {
            ...
            //
            bezierToPower(0.0, nX1, nX2, 1.0, fPolyX[3], fPolyX[2], fPolyX[1], fPolyX[0]);

            bezierToPower(fY1, fY2, fY3, fY4, fPolyY[3], fPolyY[2], fPolyY[1], fPolyY[0]);
