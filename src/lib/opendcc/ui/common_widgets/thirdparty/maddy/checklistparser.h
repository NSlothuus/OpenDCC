...
namespace maddy
{
    ...
    public:
         ...
         */
        ChecklistParser(std::function<void(std::string&)> parseLineCallback,
    ...
    protected:
        ...
        void parseBlock(std::string& line) override
        {
            ...
            if (line.empty() || line.find("</label></li><li><label>") != std::string::npos || line.find("</label></li></ul>") != std::string::npos)
            {
