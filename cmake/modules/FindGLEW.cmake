...
if(WIN32)
    find_path(
        GLEW_INCLUDE_DIR
        NAMES GL/glew.h
        HINTS "${GLEW_LOCATION}/include" "$ENV{GLEW_LOCATION}/include"
        PATHS "$ENV{PROGRAMFILES}/GLEW/include" "${PROJECT_SOURCE_DIR}/extern/glew/include"
    ...
    find_library(
        ...
        HINTS "${GLEW_LOCATION}/lib" "$ENV{GLEW_LOCATION}/lib"
        PATHS "$ENV{PROGRAMFILES}/GLEW/lib" "${PROJECT_SOURCE_DIR}/extern/glew/bin"
...
if(GLEW_INCLUDE_DIR AND EXISTS "${GLEW_INCLUDE_DIR}/GL/glew.h")
    ...
    if(GLEW_4_2)
        ...
        message(WARNING "glew-1.7.0 or newer needed for supporting OpenGL 4.2 dependent features")
    endif()
    ...
    if(GLEW_4_3)
        ...
        message(WARNING "glew-1.9.0 or newer needed for supporting OpenGL 4.3 dependent features")
    endif()
