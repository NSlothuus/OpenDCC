# Copyright Contributors to the Open Shading Language project. SPDX-License-Identifier: BSD-3-Clause
...
#
# PARTIO_INCLUDE_DIR - header location PARTIO_LIBRARIES - library to link against PARTIO_FOUND - true if Partio was
# found.
...
if(PARTIO_FOUND OR partio_FOUND)
    ...
    find_package_handle_standard_args(partio DEFAULT_MSG PARTIO_LIBRARY PARTIO_INCLUDE_DIR)
    ...
    if(PARTIO_FOUND)
        ...
        if(NOT TARGET partio::partio)
            ...
            set_target_properties(partio::partio PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${PARTIO_INCLUDE_DIR}")
            set_property(
                TARGET partio::partio
                APPEND
                PROPERTY IMPORTED_LOCATION "${PARTIO_LIBRARY}")
        endif()
    endif()
